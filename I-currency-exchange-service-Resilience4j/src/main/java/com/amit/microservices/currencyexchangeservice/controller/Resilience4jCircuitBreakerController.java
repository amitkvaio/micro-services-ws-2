...
public class Resilience4jCircuitBreakerController {
	...
	public CurrencyConversion calculateCurrencyConversionFeign_CircuitBreaker(
		...
		return new CurrencyConversion(currencyConversion.getId(), from, to, quantity,
				...
				currencyConversion.getEnvironment() + " " + "Using-Feign-Client-Circuit-Breaker");
	}
	...
	public CurrencyConversion fallbackCurrencyExchangeResponse(
	    ...
	    logger.info("####### Fallback method fallbackCurrencyExchangeResponse class Resilience4jCircuitBreakerController triggered due to: " + ex.getMessage());
	    ...
	    return new CurrencyConversion(
	            ...
	            "Fallback response: ohh! Sorry!! Looks like there are some technical problems. Please try again later. Error: Circuit Breaker :" + ex.getMessage()
	    );
	}
}
...
http://localhost:8000/currency-conversion-feign-circuit-breaker/from/USD/to/INR/quantity/10
